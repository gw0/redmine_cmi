module ManagementHelper
  ...
  def accepted_graph(metrics)
    ...
    "<img src=\"http://chart.apis.google.com/chart?cht=p3&chd=t:#{t}&chs=320x50&chl=#{labels}&chf=bg,s,65432100\" />".html_safe
  end
  ...
  def bar_graph(data, labels, opts = {})
    ...
    "<img src=\"http://chart.apis.google.com/chart?cht=bhs&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=290x170&chxt=x,y&chxr=0,#{min},#{max}&chds=#{min},#{max}&chd=t:#{t}&chxl=1:|#{l}&chf=bg,s,65432100\" />".html_safe
  end
end
